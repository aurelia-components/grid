...
System.register(['aurelia-framework'], function (_export, _context) {
  var bindable, customElement, _dec, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, Pager;
  ...
  return {
    ...
    execute: function () {
      _export('Pager', Pager = (_dec = customElement('pager'), _dec(_class = (_class2 = function () {
        function Pager() {
